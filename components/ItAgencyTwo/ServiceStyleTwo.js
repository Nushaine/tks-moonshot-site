                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6">
                                <div className="service-right-img">
                                    <img src={require("../../images/services/it-service1.png")} alt="Service Image" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-6">
                                <div className="service-left-img">
                                    <img src={require("../../images/services/it-service2.png")} alt="Service Image" />
                                </div>
                            </div>
                ...
                <div className="service-style-two ptb-100 bg-fcfbfb">
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6">
                                <div className="service-right-img">
                                    <img src={require("../../images/services/it-service3.png")} alt="Service Image" />
                                </div>
                            </div>
                        </div>
                    </div>
