                    ...
                    <div className="row">
                        <div className="col-lg-3 col-sm-6">
                            <div className="team-card text-center">
                                <img src={require("../../images/team/circle-team1.jpg")} alt="Image" className="rounded-circle" />
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="team-card text-center">
                                <img src={require("../../images/team/circle-team2.jpg")} alt="Image" className="rounded-circle" />
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="team-card text-center">
                                <img src={require("../../images/team/circle-team3.jpg")} alt="Image" className="rounded-circle" />
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="team-card text-center">
                                <img src={require("../../images/team/circle-team4.jpg")} alt="Image" className="rounded-circle" />
